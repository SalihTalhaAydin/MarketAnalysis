...
def test_tp_hit_first(sample_data):
    ...
    highs_mod.iloc[2] = 105 # Entry price at index 0 is ~100, ATR=0.5, TP mult=2 -> TP ~101. TP hit at index 2
...
def test_sl_hit_first(sample_data):
    ...
    highs_mod.iloc[1:4] = 100.5 # Keep highs below TP (~101) up to and including index 3
...
def test_time_barrier_hit_neutral(sample_data):
    ...
    prices_mod.iloc[1:7] = 100.1 # Keep price flat within bounds for entry 0 (TP~101, SL~99)
